    ...
    def __init__(self, use_pretrained=True):
        ...
        if use_pretrained:
            try:
                ...
                print("Loaded pretrained EfficientNet-B4 backbone.")
            except Exception as error:
                print(f"Could not load pretrained backbone: {error}")
                print("Falling back to randomly initialized EfficientNet-B4.")
...
def main():
    ...
    parser.add_argument("--output", default="efficientnet_b4_deepfake.pth", help="Output model weights path.")
